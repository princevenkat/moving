            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                <Link :href="route('inquiry.start', { service_type: 'moving' })">
                    <div class="card bg-base-100 shadow-xl">
                        <div class="card-body flex flex-row flex-wrap justify-between items-center">
                            <div>
                                <img src="/assets/moving.svg" alt="" class="w-12" />
                                <h2 class="font-semibold text-lg">Only moving</h2>
                            </div>
                            <img src="/assets/right-arrow.svg" alt="" class="w-6" />
                        </div>
                    </div>
                </Link>
